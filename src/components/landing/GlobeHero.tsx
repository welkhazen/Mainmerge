        ...
        >
          ...
          >
            ...
            <LandingType
              as="span"
              token="metaLabel"
              className="relative z-10 w-full text-center font-bold text-primary"
            >
              ...
              <span className="block relative">
                ...
                >
                  <TypewriterStack
                    ...
                    prefix="Your"
                    prefixClassName="font-display text-foreground font-black"
                    startScale={0.6}
                    endScale={1.15}
                    textClassName="font-display bg-gradient-to-br from-primary via-primary to-primary/60 bg-clip-text text-transparent font-black"
          ...
          >
            <LandingType as="p" token="heroBodyStrong" className="text-foreground font-bold md:text-2xl">
              Y𝗼𝘂𝗿 𝗻𝗲𝘄 𝟮𝟰/𝟳 𝗹𝗶𝘃𝗶𝗻𝗴 𝗮𝗻𝗱 𝗲𝘃𝗲𝗿-𝗴𝗿𝗼𝘄𝗶𝗻𝗴 𝗻𝗲𝘄 𝘄𝗼𝗿𝗹𝗱
            </LandingType>
            <LandingType as="p" token="sectionBody" className="font-medium md:text-lg">
