...
export function Hero({ onSignupClick }: HeroProps) {
  ...
  return (
    <section className="relative flex min-h-screen items-center overflow-hidden px-6 pb-16 pt-24 sm:pt-28 bg-raw-black">
      <div className="absolute inset-0 z-0 overflow-hidden">
        <div className="absolute inset-0 z-[1] bg-gradient-to-b from-raw-black via-raw-black to-[#0a0a0b]" />
